...
To start a shifter container with docker image instead (e.g. on NERSC), refer to the repository `https://github.com/wfa-detector/wcd-gaudi-docker`

### Setup and build Instructions
First start the docker container. Then follow the steps below:
```bash
git clone git@github.com:wfa-detector/WakefieldBeamStudiesGaudiWorkspace.git
